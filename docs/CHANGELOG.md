...
### Fixed
- drop padding on block-card inside preview popover

## [2.1.3] - 2026-05-24

### Fixed
- theme detached inserter icons + preview content for dark mode

## [2.1.2] - 2026-05-24

### Fixed
- theme block preview popover icons + text for dark mode
...
### Added
- add slot-fill API for rendering host content into IBE footer/toolbar/heading slots from outside BE's React tree

### Fixed
- update isolated block editor dependency
